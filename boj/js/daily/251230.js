...
function A_10773() {
   ...
   for (let i = 1; i < input.length; i++) {
      if (input[i]) answer.push(input[i])
      else answer.pop()
   }

   console.log(answer.reduce((cal, cur) => (cal += cur), 0))
}
// ─────────────────────────────
// 9012 괄호
// ─────────────────────────────
function A_9012() {
   ...
   for (let i = 1; i < input.length; i++) {
      ...
      count == 0 ? answer.push('YES') : answer.push('NO')
   }
...
function A_4949() {
   ...
   for (const string of input) {
      answer.push(checkBalance(string))
   }
...
function A_12789() {
   ...
   console.log(count == N + 1 ? 'Nice' : 'Sad')
}
